...
async function main() {
  ...
  console.log("Searching transcript for employee ID 1778664218542...");
  let count = 0;
  for await (const line of rl) {
    if (line.includes("1778664218542")) {
      count++;
      // Parse the JSON line to extract type, status and content snippet
      try {
